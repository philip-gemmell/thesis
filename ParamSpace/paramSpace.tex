...
\rule{\linewidth}{0.25mm}
 ...
 % Easily scalable: not only simple methodologically to introduce variation in extra parameters, but simple to apply the methodology to multiple alternative models.
